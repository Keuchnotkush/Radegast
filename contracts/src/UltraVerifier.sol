...
uint256 constant VK_HASH = 0x2b42359e17d04fa46e73dd8dfd872af5b6afab8b77b340cc098fbf98e4f91512;
library HonkVerificationKey {
    function loadVerificationKey() internal pure returns (Honk.VerificationKey memory) {
        Honk.VerificationKey memory vk = Honk.VerificationKey({
            ...
            ql: Honk.G1Point({ 
               x: uint256(0x00b3246563d13e5bd3c83186d107fc878374509aabe9ad146081e7a5996d2a46),
               y: uint256(0x263b9c3313156312fb74b9885ca3309ea9e9b706b3def6c6f1d38fa0c068436f)
            }),
            qr: Honk.G1Point({ 
               x: uint256(0x0c03794701d45afb612d3c5475523efbfe414a8b1666584825dd7add015d7206),
               y: uint256(0x04728f88d96856b183a263e8e256168bf9b47c774eb9d4455eb3ed8eb389a809)
            }),
            qo: Honk.G1Point({ 
               x: uint256(0x13560621ae8e800c25810739e838bcdc528017fc532a10250b306daa34db3516),
               y: uint256(0x16fbf7c55b5b00c599c1e0638f0473bb43e72c4ad753791bf23fac7a86e9b470)
            }),
            q4: Honk.G1Point({ 
               x: uint256(0x28da7ef4a15cf228178b61736c687821b23a4f07017f52f74b3514817edd4986),
               y: uint256(0x2a17691d3615c0f6f92a50672da91c67fd5b74dbb06a8a722a8b129290f12c41)
            }),
            qm: Honk.G1Point({ 
               x: uint256(0x03316c49a44863fcff530b5375a1b969002c5556c912f9a42d88477c72b57e22),
               y: uint256(0x259ff919d786f01038e5c8845e6a599b9c05d53230198e7ecc74093a73affd34)
            }),
            qc: Honk.G1Point({ 
               x: uint256(0x00f085c4bdf1b0f950f7b13b803f4e13e4306803adb9cb96799df2f4173c280f),
               y: uint256(0x03fb62f0c282735e586e1213d60587658fb562a3b3b8d2db264dcc669ee6d3f4)
            }),
            ...
            qArith: Honk.G1Point({ 
               x: uint256(0x05a72a386bc75bef52b21086429fc5b925ccf590bed6e962fe622d38eba516fb),
               y: uint256(0x00f38753d5e1cd269b5afde4b209b9bc02e229d215616730309cbfa183542aff)
            }),
            qDeltaRange: Honk.G1Point({ 
               x: uint256(0x103d7aee4749841d77626a033d43bab70e6e59ee63c52bb9fa92e7c0890f5737),
               y: uint256(0x137c46d1598c4c9502274fbd9a0ec6d5789273e704e9356814a11500c5c016e8)
            }),
            qElliptic: Honk.G1Point({ 
               x: uint256(0x0d700a27c33dd4a54b7f249128c7ca6a613d77e077522902ba7b5c7cc222b02c),
               y: uint256(0x28d0840a6b8c0fa1f5d8bffa32d0310ca3ffee5247e9aef6dd478f15f8be37dc)
            }),
            qMemory: Honk.G1Point({ 
               x: uint256(0x0c11e7703d92dae324d7190b9bf0a92fdcfda941a0dd540a454e0da75cfc3e20),
               y: uint256(0x11a93f91b9a1ee3f13571a1f57d5be8e63ffa89e3b541c45ae553f30defddaef)
            }),
            qNnf: Honk.G1Point({ 
               x: uint256(0x1ec2763e0eae8232dd9ecd8060fa71c8fef2a6b373faf6db2a0f906fd0b58662),
               y: uint256(0x198861474a84660a58f1a802ac9f5a465028cfc2f695d9ebc65b03fb6f5f7639)
            }),
            qPoseidon2External: Honk.G1Point({ 
               x: uint256(0x089e20622e392487d61c240064982f956593e6b0c6377f498b4706092084496a),
               y: uint256(0x2a86e259c305e5d8027a3d2f7cfb912bf2a84f9882157657b1bc6d3fe7bc72ce)
            }),
            qPoseidon2Internal: Honk.G1Point({ 
               x: uint256(0x25d752feb9b0f907accc4dec7cfb2a04f9b7c378f39d3b948b695bcbba1e7f16),
               y: uint256(0x1b253407986f8e500acc5880ccee5aa6ed6e4ceac1687ad914cfa3b30e5f7bb5)
            }),
            s1: Honk.G1Point({ 
               x: uint256(0x0c2f6915785c381d5eaa6ce2afb5e89d146ffa6de448fe9f4c7e69f44fed0175),
               y: uint256(0x24a82b74e3dea334693fc939acad338bed7e21d1d9019cb9635bea8e322d037b)
            }),
            s2: Honk.G1Point({ 
               x: uint256(0x1c6a67e36f9cf3c21b6f99530b688bc1a3a782c9cd7fe3c813781a4bd773607f),
               y: uint256(0x1d7c934f632499dacebcb001c0f14be10b68945ef62da50834a05fa04b155883)
            }),
            s3: Honk.G1Point({ 
               x: uint256(0x122d6fe89e7897e8ac15ed2a0eb6d0cb24aef80f71cbdfb3a57998ca1432f91f),
               y: uint256(0x2a96ed05a1db5980e6b0e5cb0b73b7af15572a64c1b20d0cc64516e7e672ef1a)
            }),
            s4: Honk.G1Point({ 
               x: uint256(0x0b69a969599233d30c94bf9eb7552743a4524d7ecd061a14aafac29a1a4fd0a1),
               y: uint256(0x2ff4a6147e27ecb842e7808f38f00b80ec73671b288fe4cff8839debffdf0a2c)
            }),
            t1: Honk.G1Point({ 
            ...
            id1: Honk.G1Point({ 
               x: uint256(0x0a7188937c035cac9a27c9f87730f500c6ae747c5b224fc840ded341b54ff4f8),
               y: uint256(0x1c04b48876dc6b0ad6788ba4af5f8120bf35e1bb1f198eacba9625130fbe0ca3)
            }),
            id2: Honk.G1Point({ 
               x: uint256(0x2d404ae37611784f8cd5b1fd6a2e1b2b4d1d5180e63fa9c9802b365247106741),
               y: uint256(0x0443feada8a2e8886651aae6ac7035cef24dafc83f22980c95436576f0c0991a)
            }),
            id3: Honk.G1Point({ 
               x: uint256(0x17722431dbbf32509c2784e2a828cc010972ab3a16cf2ec7bf1525ec1a9fddae),
               y: uint256(0x266acda290eeeb1536aa90734c2a80405b1f5456ccb27626de4bf148d9c47a25)
            }),
            id4: Honk.G1Point({ 
               x: uint256(0x0cd3bd3cfe0db52527c4a6660e3c475f44d2cbbbe8c1b9b3147d2eea5024b238),
               y: uint256(0x1f57911911e2827ce2628816f062670c2a2a54e7fd61a8859530592eb021af83)
            }),
            ...
            lagrangeLast: Honk.G1Point({ 
               x: uint256(0x2ad245ac74c2487b27280007ebb61024a4c2948122cacb8d118e8e53518250a8),
               y: uint256(0x003f5934795076588b46a54f6eae2f609af42b496d101bbd996cc4d02f54c680)
            })
        });
        return vk;
    }
